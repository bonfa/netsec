...
def getValueFromSbox(x,y):
	'''
	ritorna il valore corrispondente al
	'''
	if x<0 or x > 1:
		raise ValueError('x must be 0 or 1')
	if y<0 or y > 255:
		raise ValueError('y must be in range (0,256)')
	return Sbox[x][y]
