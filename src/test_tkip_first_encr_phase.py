...
class TestTkipEncryptionPhaseOne(unittest.TestCase):
	...
	def test_phaseOne_1(self):
		...
		tk = struct.pack('16B',0x0F,0x0E,0x0D,0x0C,0x0B,0x0A,0x09,0x08,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0x00)
		ta = struct.pack('6B',0x10,0x22,0x33,0x44,0x55,0x66)#struct.pack('6B',0x66,0x55,0x44,0x33,0x22,0x10)
	...
	def test_phaseOne_2(self):
		...
		tsc = struct.pack('6B',0x20,0xDC,0xFD,0x44,0xFF,0xFF)
	...
	def test_phaseOne_3(self):
		...
		tsc = struct.pack('6B',0xF0,0xA4,0x10,0xFC,0x05,0x8C)
	...
	def test_phaseOne_4(self):
		...
		ta = struct.pack('6B',94,0x5E,0x24,0x4E,0x4D,0x6E)
		tsc = struct.pack('6B',0x8B,0x15,0x73,0xB7,0x30,0xF8)
