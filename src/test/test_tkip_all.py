...
import binascii
import array
from tkip import TKIP_Decryptor_Low
...
class TestTKIP(unittest.TestCase):
	...
	'''
	def test_TKIP_decryption_1(self):
		'''
		...
		decryptor = TKIP_Decryptor_Low(ciphertext,sa,iv,tk[:16],tk[24:32])
		plaintextTuple = decryptor.decryptPayload()
		self.assertEqual(plaintext,plaintextTuple[:-4])
