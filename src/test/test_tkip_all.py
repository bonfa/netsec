...
class TestTKIP(unittest.TestCase):
	...
	def test_TKIP_decryption_01_b(self):
		...
		decryptor = TKIP_Decryptor_Low(ciphertext,sa,da,sa,iv,tk[:16],micKey,priority)
...
#		ciphertext_mpdu = struct.pack('136B',)
		...
		#creo il pacchetto		
#		scapyPacket = Dot11(ciphertext_mpdu,FCfield = 0)
		#scapyPacket.show()
#		micKey = tk[16:24]
		
		
		#scapyPacket.show()
#		decryptor = TkipDecryptor(scapyPacket,tk[:16],micKey,False)	
#		plaintextString = decryptor.getDecryptedPacket()
		#print ""
#		print (plaintextString)
#		print (expecetdPlaintext)
		#plaintextString = struct.unpack(str(len(plaintextTuple))+'B',*plaintextTuple)
